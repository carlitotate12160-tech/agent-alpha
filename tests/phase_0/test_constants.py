...
def test_scope_always_excluded_count() -> None:
    """SCOPE_ALWAYS_EXCLUDED has exactly 3 CIDR ranges."""
    assert len(SCOPE_ALWAYS_EXCLUDED) == 3


def test_time_budget_equals_hard_limit() -> None:
