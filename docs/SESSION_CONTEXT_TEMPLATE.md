...
> concerns architecture/design; offensive payload bodies are handled by DeepSeek/Kimi/SWE-1.6/XAI/Gemini/Sonnet/GPT — see K21.
...
- LLM: DeepSeek/Kimi/SWE-1.6/XAI/Gemini/Sonnet/GPT (offensive payload) + Claude (reasoning/narrative)
