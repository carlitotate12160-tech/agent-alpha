...
> by DeepSeek/Kimi/SWE-1.6/XAI/Gemini/Sonnet/GPT — see K21.
...
bodies in `templates/*` are authored by DeepSeek/Kimi/SWE-1.6/XAI/Gemini/Sonnet/GPT, NEVER by Claude. Do not ask
