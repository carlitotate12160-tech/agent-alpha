...
> by DeepSeek/Kimi/SWE-1.6/XAI/Gemini (refined based on testing) — see K21.
...
bodies in `templates/*` are authored by DeepSeek/Kimi/SWE-1.6/XAI/Gemini (refined based on testing), NEVER by Claude. Do not ask
